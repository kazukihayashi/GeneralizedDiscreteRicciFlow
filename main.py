...
face1 = np.loadtxt("face_developable.dat",dtype=int)-1
...
gamma,Iij,edge_len = RicciFlow.Optimize_Ricci_Energy(vert1,face1,gauss_target,n_step=20,u_change_factor=0.5,boundary_free=False)
